...
> **Note:** This branch (`main`) now targets **Bevy 0.18**. If you need Bevy 0.17 support, see the [`bevy-0.17`](https://github.com/greysquirr3l/bevy-archie/tree/bevy-0.17) branch.
